...
var social_goal: String = ""
var pressure_response: String = ""
var visual_direction: String = ""
...
func _init(data: Dictionary = {}) -> void:
    ...
    social_goal = str(data.get("social_goal", ""))
    pressure_response = str(data.get("pressure_response", ""))
