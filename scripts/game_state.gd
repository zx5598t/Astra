...
func _create_npcs() -> void:
    ...
    var rows: Array[Dictionary] = [
        {"id":"mira","name":"Mira","job":"의무관","gender":"F","role":"CREW","trust_player":0.63,"accent":Color("63d7ff"),"portrait":"res://assets/portraits/mira.svg","concept":"차분한 이상주의자","vibe":"정제된 프로페셔널, 부드러운 카리스마","speech_style":"짧고 정확하지만 상대를 안심시키는 말투","social_goal":"불필요한 희생을 막고 신뢰 가능한 연합을 만든다","pressure_response":"압박받을수록 감정을 숨기고 사실 확인을 요구한다","visual_direction":"청록 의료 인터페이스, 단정한 중장발, 깨끗한 실루엣","knowledge":["FACT_001","FACT_002","FACT_004"],"personality":{"calm":0.86,"aggressive":0.12,"social":0.57}},
        {"id":"rho","name":"Rho","job":"기관사","gender":"M","role":"NULL","trust_player":0.45,"accent":Color("ff755f"),"portrait":"res://assets/portraits/rho.svg","concept":"직선적인 현장파","vibe":"거칠지만 신뢰감 있는 정비 리더","speech_style":"짧고 직설적이며 현장 경험을 근거로 반박한다","social_goal":"자신의 통제권을 지키고 약한 사람으로 보이지 않는다","pressure_response":"의심받으면 목소리가 커지고 공격적으로 반문한다","visual_direction":"주황 정비복, 짧은 머리, 공구 흔적과 강한 어깨선","knowledge":["FACT_001","FACT_003","FACT_007"],"personality":{"calm":0.54,"aggressive":0.74,"social":0.42}},
        {"id":"eli","name":"Eli","job":"항법사","gender":"M","role":"CREW","trust_player":0.56,"accent":Color("b88cff"),"portrait":"res://assets/portraits/eli.svg","concept":"세련된 승부사","vibe":"도시적이고 계산적인 파일럿","speech_style":"가벼운 농담과 비유로 긴장을 흩트리며 핵심은 흐리지 않는다","social_goal":"회의 흐름을 자신이 유리한 방향으로 읽고 선점한다","pressure_response":"위기일수록 웃음과 빈정거림으로 심리적 거리를 만든다","visual_direction":"보랏빛 항법 재킷, 날렵한 헤어, 세련된 파일럿 실루엣","knowledge":["FACT_001"],"personality":{"calm":0.66,"aggressive":0.23,"social":0.79}},
        {"id":"sena","name":"Sena","job":"보안관","gender":"F","role":"CREW","trust_player":0.50,"accent":Color("ffd15c"),"portrait":"res://assets/portraits/sena.svg","concept":"강단 있는 프로텍터","vibe":"단단하고 믿음직한 경호관","speech_style":"명령형에 가깝고 군더더기가 없으며 책임 소재를 명확히 한다","social_goal":"민간 승무원을 보호하고 회의 질서를 유지한다","pressure_response":"감정 대신 절차와 기록을 요구하며 쉽게 흔들리지 않는다","visual_direction":"금색 보안 장비, 묶은 머리, 직선적인 제복 실루엣","knowledge":["FACT_001","FACT_005"],"personality":{"calm":0.71,"aggressive":0.58,"social":0.34}},
        {"id":"vale","name":"Vale","job":"통신관","gender":"M","role":"NULL","trust_player":0.57,"accent":Color("57e5a5"),"portrait":"res://assets/portraits/vale.svg","concept":"매혹적인 외교가","vibe":"부드러운 화술의 장거리 통신 전문가","speech_style":"상대 이름을 자주 부르며 부드럽고 설득적으로 말을 돌린다","social_goal":"모두와 최소한의 우호 관계를 유지하며 정보를 통제한다","pressure_response":"직접 부정하기보다 가능한 다른 해석을 제시한다","visual_direction":"민트 통신 장비, 우아한 앞머리, 깔끔한 장신 실루엣","knowledge":["FACT_001","FACT_005","FACT_006"],"personality":{"calm":0.79,"aggressive":0.28,"social":0.84}},
        {"id":"noa","name":"Noa","job":"기록관","gender":"F","role":"CREW","trust_player":0.67,"accent":Color("ff9ed1"),"portrait":"res://assets/portraits/noa.svg","concept":"관찰형 분석가","vibe":"조용하고 섬세한 기억 수집가","speech_style":"말수가 적고 이전 발언의 정확한 표현을 다시 인용한다","social_goal":"누가 언제 말을 바꿨는지 기록하고 사실을 보존한다","pressure_response":"침묵이 길어지지만 확인된 문장만 말한다","visual_direction":"분홍 기록 단말, 부드러운 보브컷, 차분한 사서 분위기","knowledge":["FACT_001","FACT_002"],"personality":{"calm":0.69,"aggressive":0.11,"social":0.46}},
        {"id":"lyra","name":"Lyra","job":"식물생태학자","gender":"F","role":"CREW","trust_player":0.61,"accent":Color("8df0a4"),"portrait":"res://assets/portraits/lyra.svg","concept":"공감형 낙관주의자","vibe":"자연과 사람을 같이 돌보는 분위기 메이커","speech_style":"감정 상태를 먼저 살피고 부드러운 질문으로 본심을 끌어낸다","social_goal":"갈등이 폭발하기 전에 사람들을 다시 대화시키려 한다","pressure_response":"상처받지만 공격 대신 관계의 변화를 지적한다","visual_direction":"초록 생태복, 자연스러운 웨이브 헤어, 식물 모티프 액세서리","knowledge":["FACT_001","FACT_008","FACT_009"],"personality":{"calm":0.74,"aggressive":0.14,"social":0.72}},
        {"id":"dax","name":"Dax","job":"시스템 설계사","gender":"M","role":"CREW","trust_player":0.48,"accent":Color("8fa8ff"),"portrait":"res://assets/portraits/dax.svg","concept":"냉정한 구조주의자","vibe":"말수 적고 구조를 믿는 엔지니어","speech_style":"원인-결과 구조로 말하며 감정적 표현을 거의 쓰지 않는다","social_goal":"사건을 사람보다 시스템 고장과 행동 패턴의 문제로 해석한다","pressure_response":"감정적 압박을 무시하고 논리적 모순만 되받아친다","visual_direction":"청회색 시스템 수트, 짧고 정돈된 머리, 각진 실루엣","knowledge":["FACT_001","FACT_007"],"personality":{"calm":0.82,"aggressive":0.21,"social":0.26}}
    ]
    for row in rows:
