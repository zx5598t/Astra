...
const EVENTS := {
    "mira": [
        ...
        {"scene":"미라가 찬 물컵을 손바닥으로 감싸고 있다. 아직 한 모금도 마시지 않았다.","prompt":"“수면에서 깨면 목이 마른 게 정상인데… 오늘은 물 냄새가 이상하게 느껴져요.”","choices":[{"label":"새 컵을 가져다준다.","hint":"","effect":"comfort_light"},{"label":"“오늘 다른 이상한 건 없었어요?”","hint":"","effect":"witness"}],"min_day":2},
    ...
    "sena": [
        ...
        {"scene":"세나가 식판을 문 옆에 둔 채 먹지 않고 있다.","prompt":"“순찰 돌다 먹으려고. 차가운 건 익숙해.”","choices":[{"label":"“5분만 앉아서 먹어.”","hint":"","effect":"comfort"},{"label":"같이 순찰 동선을 확인한다.","hint":"","effect":"flow"}],"min_stress":0.3},
    ...
    "vale": [
        ...
        {"scene":"소렌이 음악 파일과 통신 파일을 같은 재생 목록에 넣었다가 멈춘다.","prompt":"“둘 사이가 너무 비슷해서 싫어요. 음악까지 의심하게 되니까.”","choices":[{"label":"음악 파일은 따로 빼 둔다.","hint":"","effect":"comfort"},{"label":"통신 파일만 기록으로 남긴다.","hint":"","effect":"open_records"}],"min_stress":0.35},
    ...
    "noa": [
        ...
        {"scene":"노아가 회의 기록의 말줄임표를 전부 지우고 있다.","prompt":"“멈춘 시간이 다 달라 보여요. 말 안 한 것도 기록일까요?”","choices":[{"label":"침묵도 시간과 함께 남긴다.","hint":"","effect":"flow"},{"label":"“해석은 나중에 하자.”","hint":"","effect":"procedure"}],"min_day":2},
    ...
    "dax": [
        ...
        {"scene":"다렌이 의자 등받이에 기대 눈을 감고 숫자를 외운다.","prompt":"“화면을 오래 보면 내가 본 건지 시스템이 보여 준 건지 섞여.”","choices":[{"label":"종이에만 기록해 둔다.","hint":"","effect":"dax_hint"},{"label":"“잠깐 쉬자.”","hint":"","effect":"comfort_light"}],"min_stress":0.35},
