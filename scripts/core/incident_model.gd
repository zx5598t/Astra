...
# 0.7.0: every incident's "chapters" list gained the six ACT II days
# (SECOND_WATCH..THRESHOLD) — see storylets_052.gd's MID_CHAPTERS comment for
# the same reasoning. The existing 8 types already cover every domain the ACT
# II design brief calls for (medical/archive/comms/nav/ecology/security), so
# no new incident types were needed (§27).
const INCIDENTS := {
    "COMMS_SPIKE":{
        "chapters":["ECHO_WARD","SILENT_ORBIT","RED_SHIFT","LAST_LIGHT","SECOND_WATCH","BORROWED_DAYS","BLIND_DECK","THREE_MINUTES_DARK","CONTINUITY","THRESHOLD"],"actor":"vale",
    ...
    "POWER_RELAY":{
        "chapters":["ECHO_WARD","SILENT_ORBIT","RED_SHIFT","LAST_LIGHT","SECOND_WATCH","BORROWED_DAYS","BLIND_DECK","THREE_MINUTES_DARK","CONTINUITY","THRESHOLD"],"actor":"rho",
    ...
    "DOOR_LOCK":{
        "chapters":["ECHO_WARD","SILENT_ORBIT","RED_SHIFT","LAST_LIGHT","SECOND_WATCH","BORROWED_DAYS","BLIND_DECK","THREE_MINUTES_DARK","CONTINUITY","THRESHOLD"],"actor":"sena",
    ...
    "NAV_DRIFT":{
        "chapters":["SILENT_ORBIT","RED_SHIFT","LAST_LIGHT","SECOND_WATCH","BORROWED_DAYS","BLIND_DECK","THREE_MINUTES_DARK","CONTINUITY","THRESHOLD"],"actor":"eli",
    ...
    "OXYGEN_BALANCE":{
        "chapters":["RED_SHIFT","LAST_LIGHT","THREE_MINUTES_DARK","CONTINUITY","THRESHOLD"],"actor":"mira",
    ...
    "SAMPLE_CONTAINMENT":{
        "chapters":["RED_SHIFT","LAST_LIGHT","THREE_MINUTES_DARK","CONTINUITY","THRESHOLD"],"actor":"lyra",
    ...
    "ARCHIVE_CORRUPTION":{
        "chapters":["SILENT_ORBIT","RED_SHIFT","LAST_LIGHT","SECOND_WATCH","BLIND_DECK","THREE_MINUTES_DARK","THRESHOLD"],"actor":"noa",
    ...
    "MEDICAL_SHORTAGE":{
        "chapters":["ECHO_WARD","SILENT_ORBIT","RED_SHIFT","LAST_LIGHT","SECOND_WATCH","BORROWED_DAYS","BLIND_DECK","THREE_MINUTES_DARK","CONTINUITY","THRESHOLD"],"actor":"mira",
...
static func should_trigger(seed_value: int, loop_index: int, chapter: String, action_index: int, history: Array, active_incident: Dictionary) -> bool:
    ...
    for event in history:
        if int(event.get("loop",-1)) == loop_index:
            return false
    if chapter in ["RED_SHIFT","LAST_LIGHT","THREE_MINUTES_DARK","THRESHOLD"]:
