...
const SCENES := [
    ...
    },
    {
        ...
        "speaker": "sena",
        "tag": "awakening",
        "action": "포드가 열리자 세나는 숨을 고르기도 전에 비상문을 찾는다.",
        "lines": [
            [
                "sena",
                "문은? 다들 나갈 수 있어? 준, 너 또 혼자 들어갔지."
            ]
        ],
        "choices": []
    },
    ...
    },
    {
        ...
        "speaker": "vale",
        "tag": "awakening",
        "action": "소렌은 눈을 뜨자마자 귀를 막는다. 아무 경보도 울리지 않는다.",
        "lines": [
            [
                "vale",
                "그 소리. 아직 들려요?"
    ...
    },
    {
        ...
        "speaker": "eli",
        "tag": "awakening",
        "action": "루칸이 포드에서 나와 곧장 창을 찾는다.",
        "lines": [
            [
                "eli",
                "어느 방향으로 가고 있지? 창이 있는 곳으로 가자."
            ]
        ],
        "choices": []
    },
    ...
    },
    {
        ...
        "speaker": "lyra",
        "tag": "awakening",
        "action": "마렌은 포드 문이 열리자 말라 있는 화분부터 품에 안는다.",
        "lines": [
            [
                "lyra",
                "누가 물 줬어요? 고마워요. 잠깐, 이 씨앗은 여기 있으면 안 되는데."
            ]
        ],
        "choices": []
    },
