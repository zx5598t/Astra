...
static func text() -> String:
    ...
    return "\n".join(PackedStringArray([
        ...
        "첫 회의에서 모두가 알리바이를 공개하고, 같은 장소에 있던 사람들이 서로 반박합니다. 조사관은 제한된 발언 기회로 [b]단서 공개[/b], [b]가설 제시[/b], [b]지목[/b], [b]변호[/b]를 할 수 있습니다.",
        "공개된 근거가 있는 지목은 설득력이 크고, 근거 없는 지목은 조사관의 신뢰를 떨어뜨립니다. 정확한 표는 개표 후 공개됩니다. 회의 중에는 발언과 반응을 읽어 보세요.",
        "",
        ...
        "이름을 선택하고 화면 아래 [b]내 판단 표시(M)[/b] 버튼으로 두 명을 [b]N(Null 의심)[/b]으로 표시해 두면 투표할 때 추리 보고서가 함께 제출되고, 사건 종료 후 채점됩니다.",
        "",
        ...
        "장소의 조사 지점이나 복구 설비를 살피면 30분이 흐릅니다. 장소 이동과 노트 열기는 무료입니다. 어떤 기록을 남길지 선택하세요. 설비 복구는 현장 조사 시간을 쓰지만 이후 조사나 동료 보호에 도움이 됩니다.",
