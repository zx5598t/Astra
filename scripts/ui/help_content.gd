...
static func text() -> String:
    ...
    return "\n".join(PackedStringArray([
        ...
        "이름 옆 표시 버튼으로 두 명을 [b]N(Null 의심)[/b]으로 표시해 두면 투표할 때 추리 보고서가 함께 제출되고, 사건 종료 후 채점됩니다.",
        "",
        ...
        "각 사건의 선택 임무는 조사 행동력 1을 씁니다. 증거 보호, 기록 복원, 심문·발언권 추가 등 보상을 비교해 수행하세요. 오른쪽 목표에서 진행을 확인할 수 있습니다.",
        ...
        "Space 다음 단계 · Tab 버튼 이동 · Enter 선택 버튼 실행 · 1~8 승무원 선택 · M 선택한 승무원 표시 변경 · N 노트 탭 전환 · Esc 메뉴 · F11 전체 화면"
    ]))
