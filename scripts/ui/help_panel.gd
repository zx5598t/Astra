...
const TERMS := [
    ...
    ["발언", "회의에서 하루 세 번 할 수 있는 강한 행동. 누군가의 말과 내가 아는 근거를 이어서 따지기, 기록 꺼내기, 되묻게 하기, 감싸기, 지목하기. 맞는 연결은 방을 움직이고, 억지 연결은 신뢰를 잃는다. 당신을 믿는 사람일수록 당신 말에 따라 표를 옮긴다."],
    ["확인 질문", "회의에서 하루 세 번, 지금 논점에 대해 짧게 묻는 것. 기록을 누가 열었는지, 정확히 무엇을 봤는지, 시각이 맞는지, 함께 있었다는 사람이 인정하는지. 무게를 더하지는 않지만, 말해진 문제만 방이 따진다."],
    ["연결", "진술 하나 + 근거 하나(또는 서로 다른 사람의 근거 둘). 같은 것을 보여 주는 근거라면 어느 것이든 된다. 결과: 모순 · 후보를 좁힘 · 뒷받침 · 전언뿐 · 같은 출처 · 이미 설명됨 · 관계없음."],
    ["되감기", "Stage에서 지면 한 번, 그날 아침으로 돌아갈 수 있다. 같은 사람, 같은 진실. 기억하는 건 당신뿐이라 다시 물어야 한다."],
