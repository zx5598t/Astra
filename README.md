...
0.8.2는 사람 중심 사회추리를 유지하면서, 플레이어가 누구에게 무엇을 물었는지가 공개 근거·회의 판단·투표 변화로 이어지는 경로를 더 분명하게 추적하고 보여 주는 안정화 패스입니다.
...
Windows: `ASTRA-0.8.2-windows.zip`을 풀고 `ASTRA/ASTRA.exe`를 실행합니다. 선택형 AI를 켜지 않으면 네트워크가 필요 없습니다.
