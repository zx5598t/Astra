...
0.9.0에서는 여섯 탐사요원(세린·미카·제이스·라엘·로건·시아) 중 한 사람을 골라 시작합니다. 누구를 골라도 진실은 같지만, 묻는 말과 승무원이 받아들이는 방식, 회의에서의 말투가 다릅니다. 도트 캐릭터 14명 모두 원본 동작 시트에서 잘라 낸 인사·놀람·환호·생각·앉기 등의 동작과 자연스러운 전환을 갖습니다.
...
Windows: `ASTRA-0.9.0-windows.zip`을 풀고 `ASTRA/ASTRA.exe`를 실행합니다. 선택형 AI를 켜지 않으면 네트워크가 필요 없습니다.
